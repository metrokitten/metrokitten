...
![Profile views](https://komarev.com/ghpvc/?username=metrokitten&color=brightgreen)

Thanks for your interest in my profile :P
Have fun reading :)
...
Hello! I'm **MetroKitten / Metro / Metr**, a Turkish student who is passionate, sarcastic, and determined to make stuff.
I am religiously in favor of cats 😼

I spend most of my time doing random things such as studying, building websites, Discord development & jobs (part-time), game modding, messing with my laptop, and music. Sometimes I act like I’m not being censored on the internet (I am), but thanks to my friend [deka](https://0x64656b61.pages.dev/), I’m *almost* free of governmental restrictions 😄

I also have a personal website:
👉 <https://metrokitten.nekoweb.org>
(Go there if you want to see **MetrOS**!)
...
- Coding
- Travelling
- Watching [Gibi ASMR](https://gibiofficial.com/) and [Lyanna Kea](https://youtube.com/@lyannakea)
...
### 🍭 [Candy Crush Forever!](https://github.com/metrokitten/CandyCrushForever)
A web-based platform that combines a powerful **Level Editor** and a functional **Web Player** for creating and playing custom Candy Crush Saga levels, entirely in your browser!

### 💢 [File Sandbox](https://github.com/metrokitten/File-Sandbox)
My goal is to discover *every file extension in the world* >:)
This repo contains many file types, each showcasing its unique structure and characteristics.
Enjoy exploring. Don’t get lost :P

### 🇪🇺 [e-Twinning Knowledge Base](https://github.com/metrokitten/eTwinning-Knowledge-Base)
...
> (Hopefully ditching Xiaomi HyperOS for a custom ROM...)

### Apps, Services & Communities
...
> [!NOTE]
>
> Yes, I use all of these. Yes, I am a menace to society. Thank you.
...
- Discord: `_metr_`
- Signal: `metrlith.07`
- Website: <https://metrokitten.nekoweb.org>
